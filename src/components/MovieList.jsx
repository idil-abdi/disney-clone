...
return (
    <div className="relative" >
        ...
        <IoChevronForwardOutline onClick={() => slideRight(elementRef.current)} className="text-[50px] text-white hidden md:block p-2 cursor-pointer mt-[150px]  z-10 top-0 absolute right-0"/>
    </div>
)
}
